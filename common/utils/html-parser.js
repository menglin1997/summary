...
var GRT = [
  ...
  // b 样式
  ['b', "font-size:1em; line-height:1.6em;"],
  // strong 样式
  ['strong', "font-size:1em; line-height:1.6em;"],
  // code 样式
  ['code', "font-size:1em; line-height:1.2em; background:#F6F7F8; padding:8px 2%; width:96%;"],
  // img 样式
  ['img', "width:100%; margin:8px 0;"],
  // blockquote
  ['blockquote', "font-size:1em; border-left:3px solid #D1D1D1; line-height:1.6em; border-radius:5px; background:#F6F7F8; padding:8px 2%;"],
  // li 样式
...
const parseHtml  = (html) => {
  html = html.replace(/<pre.*pre>?/gis, function(word){
    word =  word.replace(/[\n]/gi,'<br />');
    word =  word.replace(/    /gi,'<span style="padding-left:1.6em;"></span>');
    return word.replace(/[\t]/gi, '<span style="padding-left:1.6em;"></span>');
  });
